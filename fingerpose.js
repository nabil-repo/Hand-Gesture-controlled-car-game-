!(function (t, e) {
  ...
  return (function (t) {
    ...
    function (t, e, n) {
          ...
          (n = [
            ...
            },
            {
              ...
              value: function (t, e, n, r) {
                ...
                return h == Math.max(h, p, y)
                  ? this.estimateVerticalDirection(c, l, f, d)
                  : y == Math.max(p, y)
                  ? this.estimateHorizontalDirection(a, i, o, s)
                  : this.estimateDiagonalDirection(c, l, f, d, a, i, o, s);
              },
            },
            {
              key: "calculateSlope",
      ...
      var L = I,
        _ = new R("thumbs_up");
      _.addCurl(a.Thumb, o.NoCurl, 1),
        _.addDirection(a.Thumb, l.VerticalUp, 1),
        _.addDirection(a.Thumb, l.DiagonalUpLeft, 0.9),
        _.addDirection(a.Thumb, l.DiagonalUpRight, 0.9);
      for (
        var E = 0, j = [a.Index, a.Middle, a.Ring, a.Pinky];
        E < j.length;
        E++
      ) {
        var x = j[E];
      ...
      _.addDirection(a.Index, l.DiagonalUpLeft, 1),
        _.addDirection(a.Index, l.HorizontalLeft, 1),
        _.addDirection(a.Index, l.HorizontalRight, 1),
        _.addDirection(a.Index, l.DiagonalUpRight, 1);
      var P = _;
      e.default = {
        GestureEstimator: M,
